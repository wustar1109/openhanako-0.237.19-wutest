...
export function classifyHttpRoute({ method = "GET", path = "" } = {}) {
  ...
  if (routePath === "/ws/infinite-canvas" || routePath.startsWith("/ws/infinite-canvas/")) return LOCAL_ONLY;
  if (routePath === "/api/infinite-canvas" || routePath.startsWith("/api/infinite-canvas/")) return LOCAL_ONLY;
