 ...
 *
 * Keep this in sync with log-redactor.cjs, which is retained for Electron main
 * and other CommonJS entry points.
 */
...
export function redactLogText(value, options = {}) {
...
export function redactLogValue(value, options = {}, state = {}) {
...
export function redactLogLabel(value) {
  return redactLogText(value == null ? "unknown" : String(value))
    .replace(/[^a-zA-Z0-9_.:-]+/g, "_")
    .slice(0, 80) || "unknown";
}

export function formatLogArgs(args, options = {}) {
